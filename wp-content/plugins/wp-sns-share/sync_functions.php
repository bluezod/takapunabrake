...
if (!function_exists('WPSNSShare_sync')) {
	...
	function WPSNSShare_widget() {
		...
		echo '<p>
			...
			<input type="radio" name="WPSNSShare_widget_sync" value="2" onclick="document.getElementById(\'WPSNSShare_widget_sync_choose\').style.display=\'\'" /> 选择（将跳过默认设置）
			</p>';
		echo '<p id="WPSNSShare_widget_sync_choose" style="display:none">';
