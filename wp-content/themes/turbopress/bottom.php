		...
		<div class='footer_txt'>
			<?php
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/turbopress/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/' target='_blank'>Templates free</a>, thanks to: <a href='http://wpdis.co/' target='_blank'>Magazine theme WordPress</a>, <a href='http://lizardthemes.com' target='_blank'>LizardThemes.com</a> and <a href='http://fthe.me/bluemusic/' target='_blank'>Free music WordPress themes</a></div>
		</div>
		</div>
<?php wp_footer(); ?>
</div>
